//! SHA-256 implemented from scratch and a content-address hash type.
//!
...
/// A 32 byte content address (the SHA-256 digest of some bytes).
...
impl Hash {
    ...
    /// First 8 hex characters, for compact logging and status output.
...
mod tests {
    ...
    fn multi_block_vector() {
        let v = sha256(b"abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq").to_hex();
        assert_eq!(
            v,
